...
// API
let api;
var apiKey = "98160b8192f707a1517b45793bdc7d29";
...
function weatherDetails(info){
  ...
  //..our css style changes the text info background 
  if(info.cod == "404"){ 
...
function onSuccess(position){
  ...
  //..getting the lat and long from coordinator object
...
// Fetch weather data by pressing the keyboard key Enter
